...
В данной работе рассматривается новый метод повышения качества обучения моделей, а также увеличения их обобщающей способности, основанный на ансамбле промежуточных решений.
...
Для проверки качества работы представленного метода решим задачу классификации на 3 выборках данных с систолическим артериальным давлением. Данные заранее разбиты на обучающую и тестовую выборки. Размеры каждой из выборок представлены в таблице \ref{tabular:datasize}. Все параметры являются численными.
